...
<div style="display: flex; justify-content: space-between;  margin-bottom: 20px;">
  ...
  <p style="margin: 0 20px;">I'm a versatile and multidisciplinary programmer, with a strong foundation in several programming languages such as C#, C++, C, Python, Java, Matlab, Lua... Paired with my varied game modding experience, making me a fast learner that can quickly adapt to any new technology or ongoing project. This is clearly shown by my varied porfolio, where you can find my work on 2D and 3D games, AI systems, synchronous online game modes, procedural dungeons, stealth systems, motion tracking apps, mods that drastically change gameplay, inventory systems, and much more.</p>
...
<div style="display: flex;">
  <p style="margin-right: 10px;">Developed <a href="/portfolio/motiontracker/"><strong>MotionTracker</strong></a>, a Python-based target tracking system that worked with both moving targets and cameras. Using agile methodologies.<br><br>
