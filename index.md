...
<div class="row">
  ...
  <div class="column3" style="background: linear-gradient(to bottom, #96D1CD, #7FBFB9); border:1px solid #000; border-radius:10px; text-align:center; font-size:18px; box-shadow:5px 5px 10px rgba(0, 0, 0, 0.5);">
    ...
    <p style="line-height: 1.9;"><strong>English</strong>: <span style="border: 1px solid #000; border-radius: 15px; padding: 5px; margin: 2px;">IGCSE English as First Language</span>  <span style="border: 1px solid #000; border-radius: 15px; padding: 5px; margin: 2px;">IELTS C1</span></p>
  </div>
